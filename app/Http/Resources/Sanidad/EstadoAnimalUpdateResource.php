...
class EstadoAnimalUpdateResource extends JsonResource
{
    /**
     * Transforma el recurso a un array limpio estándar V2 (snake_case) para la edición.
     *
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'estado_salud_id' => $this->estado_salud_id,
