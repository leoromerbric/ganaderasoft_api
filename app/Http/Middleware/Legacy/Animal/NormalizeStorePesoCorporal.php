...
class NormalizeStorePesoCorporal
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (isset($data['clasificacion_etaria'])) {
                ...
                // Mapear campos heredados del clasificador a legacy si aplica
    ...
    {
        return [
            'fecha_peso' => $input['Fecha_Peso'] ?? null,
            'peso'       => $input['Peso'] ?? null,
            'comentario' => $input['Comentario'] ?? null,
            'animal_id'  => $input['peso_etapa_anid'] ?? null,
            'etapa_id'   => $input['peso_etapa_etid'] ?? null,
        ];
    }
