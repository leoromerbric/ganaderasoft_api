...
class NormalizeUpdateTipoAnimal
{
    /**
    ...
    {
        $payload = [];
        if (array_key_exists('tipo_animal_nombre', $input)) {
            $payload['nombre'] = $input['tipo_animal_nombre'];
        } elseif (array_key_exists('nombre', $input)) {
