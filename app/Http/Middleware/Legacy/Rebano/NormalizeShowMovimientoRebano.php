...
class NormalizeShowMovimientoRebano
{
    /**
    ...
    {
        // Relación finca origen — usa relación si está cargada, si no usa FK escalar
        ...
        // Relación rebaño destino (objeto, clave rebano_destino_rel)
        ...
        return [
            'id_Movimiento'     => $item['id'],
            // IDs: usa la relación si está disponible, si no el FK escalar
