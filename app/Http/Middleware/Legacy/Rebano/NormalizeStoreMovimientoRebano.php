...
class NormalizeStoreMovimientoRebano
{
    /**
    ...
    {
        return [
            'finca_id'          => $input['id_Finca'] ?? null,
            'rebano_id'         => $input['id_Rebano'] ?? null,
            'rebano_destino'    => $input['Rebano_Destino'] ?? null,
            'finca_destino_id'  => $input['id_Finca_Destino'] ?? null,
            'rebano_destino_id' => $input['id_Rebano_Destino'] ?? null,
    ...
    private function transformToLegacyFormat(array $item): array
    {
        ...
        return [
            ...
            'rebano_origen'     => null,
            'finca_destino'     => null,
            'rebano_destino'    => null, // Legacy object key, kept for compatibility
